...
**How to install:**
1. In Microsoft Sentinel, go to Workbooks and click Add workbook
2. Click Edit
3. Click Advanced Editor
4. Use the Gallery Template tab (not ARM Template) and paste the JSON
5. Click Apply
6. Click Done Editing and Save As your own workbook

**Quick checklist before you deploy:**
- You need the right data connected (M365 audit / OfficeActivity, Entra sign-ins, Defender tables, etc.). If the connectors are not on, the workbook will not magically invent logs.
